...
// TODO
// + fix else if -> done for statement, need for generate
// + fix operator precedence
// + hier id get the last bit-select into it -> check if this file has same issue
...
// DT: above syntax don't care if/else if/ else if nesting
conditional_statement
    : if_statement ({_input.LA(1)==Else && _input.LA(2)==If}? elseif_statement |
               {_input.LA(1)==Else}? else_statement | )
    ;
...
if_statement
    ...
    ;
elseif_statement
    : Else If Open_parenthesis conditional_expression Close_parenthesis statement_semicolon
    ;
else_statement
    : Else statement_semicolon
    ;
